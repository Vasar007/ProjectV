...
CREATE TABLE tmdb(
    thing_id INT
        CONSTRAINT FK_tmdb_thing_id FOREIGN KEY (thing_id) REFERENCES common(thing_id)
        ON DELETE CASCADE
        NOT NULL,
...
CREATE TABLE results(
    id INT
        CONSTRAINT PK_id PRIMARY KEY CONSTRAINT PK_result_id DEFAULT NEXT VALUE FOR result_seq,

    thing_id INT
        CONSTRAINT FK_result_thing_id FOREIGN KEY (thing_id) REFERENCES common(thing_id)
        ON DELETE CASCADE
        NOT NULL,
