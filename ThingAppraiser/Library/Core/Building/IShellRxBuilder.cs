...
{
    /// <summary>
    /// Creates interface to build <see cref="ShellRx" /> class step by step.
    /// </summary>
    public interface IShellRxBuilder
    {
        /// <summary>
        ...
        /// <summary>
        /// Collects all managers and initializes <see cref="ShellRx" /> instance.
        /// </summary>
