...
namespace ProjectV.DAL.EntityFramework
{
    ...
    public sealed class ProjectVContext : DbContext
    {
        ...
        {
            const string connectionString = @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=ProjectV;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
